...
export function Sidebar() {
  ...
  // For demo purposes - you would typically get this from your auth context
  const isAdmin = true
  ...
  const iconColors = {
    ...
    messages: 'group-hover:text-[hsl(12,76%,61%)]', // Red
        ...
        <div className="space-y-1">
          ...
          <Link href="/messages">
            <motion.div
              ...
              whileTap={{ scale: 0.98 }}
            >
              <MessageSquare className={`w-5 h-5 transition-colors ${iconColors.messages}`} />
              Messages
            </motion.div>
          </Link>
