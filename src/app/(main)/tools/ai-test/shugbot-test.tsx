...
export default function ShugBotTest() {
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="p-8">
        <PageHeader 
          heading="ShugBot Test Environment"
        ...
        <div className="flex-1 overflow-y-auto p-8 space-y-4">
          {messages.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full text-center">
              ...
              <h3 className="text-lg font-medium mb-2">ShugBot Test Environment</h3>
              <p className="text-sm text-zinc-400 max-w-md">
                Testing Gemini AI integration. Ask me anything!
              </p>
            </div>
          ) : (
            messages.map((msg) => (
