 ...
 * 
 * This is part of the isolated AI implementation.
 * - DO NOT modify auth system
 * - DO NOT change database schemas
 * - DO NOT integrate with production systems
 * - MUST use test environment for all changes
 * 
 * Read full guidelines: /Documentation/2-core-standards/AI_INTEGRATION_STANDARDS.md
 */
